...
<body style="background-color: rgb(56,66,67);color: #ffffff;font-family: Amaranth, sans-serif;">
    ...
    <div class="login-dark">
        <form method="post">
            ...
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Log In</button><label class="text-center" id="error" style="width: 100%;color: rgb(220,53,69);"><?php if (isset($error_msg)): ?><?= $error_msg ?><?php endif ?></label></div><a class="forgot" href="register.php">Create an account</a></form>
    </div>
